...
const E_Huella = ({ unidad = '500'}) => (
  <svg 
  xmlns="http://www.w3.org/2000/svg" 
  xmlnsXlink="http://www.w3.org/1999/xlink" 
  viewBox="0 0 500 500"  // Valor fijo
  width='500' 
  height='500'
  ...
  >
    <g transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)"
       style={{
        ...
        <path
          d="M 57.128 62.032 V 50.243 c 5.479 -0.269 10.957 -2.961 16.436 -8.077 c 3.996 3.731 7.992 6.167 11.988 7.32 c 0.153 -1.475 0.234 -2.971 0.234 -4.486 c 0 -23.689 -19.204 -42.893 -42.893 -42.893 S 0 21.311 0 45 c 0 23.689 19.204 42.893 42.893 42.893 c 7.88 0 15.258 -2.135 21.604 -5.843 C 60.216 77.96 57.128 71.894 57.128 62.032 z"
          style={{
            fill: "rgb(221,234,237)",
            strokeWidth: 1,
            strokeLinecap: "round"
          }}
        />
        <path
          d="M 73.564 87.893 C 81.782 84.119 90 78.126 90 62.032 V 50.243 c -5.479 -0.269 -10.957 -2.961 -16.436 -8.077 c -5.479 5.116 -10.957 7.808 -16.436 8.077 v 11.789 C 57.128 78.126 65.346 84.119 73.564 87.893 L 73.564 87.893 z"
          style={{
            fill: "rgb(46,140,204)",
            strokeWidth: 1,
            strokeLinecap: "round"
        ...
        />
        <path
          d="M 73.752 74.865 h -0.376 c -3.21 0 -5.812 -2.602 -5.812 -5.812 v -4.612 h 12 v 4.612 C 79.564 72.263 76.962 74.865 73.752 74.865 z"
          style={{
            fill: "rgb(254,183,86)",
            strokeWidth: 1,
            strokeLinecap: "round"
        ...
        />
        <path
          d="M 77.227 65.489 c -0.553 0 -1 -0.447 -1 -1 v -5.584 c 0 -1.468 -1.194 -2.662 -2.663 -2.662 c -1.468 0 -2.662 1.194 -2.662 2.662 v 5.584 c 0 0.553 -0.447 1 -1 1 s -1 -0.447 -1 -1 v -5.584 c 0 -2.57 2.092 -4.662 4.662 -4.662 c 2.571 0 4.663 2.092 4.663 4.662 v 5.584 C 78.227 65.042 77.779 65.489 77.227 65.489 z"
          style={{
            fill: "rgb(254,183,86)",
            strokeWidth: 1,
            strokeLinecap: "round"
